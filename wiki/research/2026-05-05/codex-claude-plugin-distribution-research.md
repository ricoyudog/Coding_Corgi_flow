...
> 研究如何將 Corgi GitFlow (CorgiSpec) 專案的 17 個 Agent Skills 包裝成 Plugin，透過兩個平台的 Marketplace 分發給團隊。
...
```json
{
  "name": "corgispec",
  "version": "2.0.0",
  "description": "Corgi GitFlow — AI-driven change management: propose → apply → review → archive",
  "author": {
    "name": "呆呆王",
    "url": "https://github.com/your-org/openspec_gitflow_modified"
  },
  "license": "MIT",
  "keywords": ["corgispec", "corgi-workflow", "gitflow", "change-management", "spec-driven"],
  "repositories": [
...
```json
{
  "name": "corgispec",
  "version": "2.0.0",
  "description": "Corgi GitFlow — AI-driven change management",
  "skills": "./skills/"
}
```
...
```json
{
  ...
  "interface": {
    ...
    "longDescription": "Corgi GitFlow 提供完整的 AI 驅動變更管理：propose → apply → review → archive，支援 GitLab/GitHub 整合、memory 持久化、worktree 隔離。",
    "developerName": "呆呆王",
    "category": "Workflow",
