...
| `WorktreeCreate` | `corgispec hook worktree-create` | 初始化 worktree 中的 OpenSpec 结构 | 0=就绪 |
...
- [[wiki/research/hook-study/claude-code-hooks]] — Claude Code 28 events · 5 hook types
- [[wiki/research/hook-study/opencode-hooks]] — OpenCode 14 plugin hooks + 40+ events
- [[wiki/research/hook-study/codex-hooks]] — Codex 8 events · TOML+JSON
