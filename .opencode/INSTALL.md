...
3. Install the prerelease with `npm install -g corgispec@next`; `next` currently resolves to `3.0.0-rc.2`. Use `npm install -g corgispec@3.0.0-rc.2` for an exact pin. The unqualified package and `latest` remain on stable `2.4.3`.
